...
// code modified by Davis Farrow for CPE 422 HW5 pb 3
// when invalid input value is entered by user, LED will blink for 1 second on, 1 second off
...
int main(int argc, char* argv[]){
   ...
   if(strcmp(argv[1],"on")==0){
	...
	printf("LED will now blink for 1 sec ON, 1 sec OFF\n");
   	writeLED("/trigger", "timer");
